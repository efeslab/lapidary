			...
			size_t max)
{
  ...
  IFUNC_IMPL (i, name, strcmp,
        ...
        IFUNC_IMPL_ADD (array, i, strcmp, 1, __strcmp_sgx))
  ...
  IFUNC_IMPL (i, name, memcpy,
	      IFUNC_IMPL_ADD (array, i, memcpy, 1, __memcpy_sgx))
  ...
  IFUNC_IMPL (i, name, mempcpy,
	      IFUNC_IMPL_ADD (array, i, mempcpy, 1, __mempcpy_sgx))
...
void *__memset_sgx (void *dst, int c, size_t n )
{
    if (n != 0) {
                unsigned char *d = dst;
...
void *__memset_chk_sgx (void *dst, int c, size_t n, size_t dest_len)
{
	if( dest_len > n )
        return (void*)0;

    return __memset_sgx( dst, c, n );
}
